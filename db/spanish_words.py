the_most_common_spanish_words_136 = [
    ("de", "of, from"),
    ...
    ("entonces", "so, then"),
    ("poner", "to put (on), to get [adjective]"),
    ("(la) cosa", "thing"),
    ("(el) hombre", "man, mankind, husband"),
...
the_most_common_spanish_words_1000 = [
    ("como", "as"),
    ("yo", "I"),
    ("su", "his"),
    ("que", "that"),
